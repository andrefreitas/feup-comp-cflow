...
public class ENFA {
	...
	public static ENFA operator_or(ENFA enfa1,ENFA enfa2) {
		...
		//Adds the first transition from the new initial state to the enfa2 initial state
		...
		//Connects all the accept states from the enfa1 to the final state of the new enfa
		it = enfa1.accept_states.iterator();
		for(;it.hasNext();) {
			i = Integer.parseInt(it.next().substring(1))+1;
			transition[0] = "q" + i; //state
